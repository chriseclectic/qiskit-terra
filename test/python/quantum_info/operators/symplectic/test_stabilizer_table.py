...
class TestStabilizerTableMethods(QiskitTestCase):
    ...
    def test_unique(self):
        ...
        with self.subTest(msg='2 qubit'):
            labels = ['XX', 'IX', '-XX', 'XX', '-IZ', 'II',
                      'IZ', 'ZI', 'YX', 'YX', 'ZZ', 'IX', 'XI']
    ...
    def test_insert(self):
        ...
        for j in range(1, 10):
            ...
            insert = StabilizerTable.from_labels(['-' + j * 'I', j * 'Y',
                                                  '-' + j * 'Z'])
            target0 = insert + stab
            target1 = stab + insert
    ...
    def test_compose_qargs(self):
        ...
        stab1 = StabilizerTable.from_labels(
            ['III', '-XXX', 'YYY', '-ZZZ'])
